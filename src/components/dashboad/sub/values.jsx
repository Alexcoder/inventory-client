        ...
        allDashboard?.slice(startIndex, endIndex).map((list) => (
          <div key={list._id} style={{ background: "white" }}>
            <div style={{ display: "flex", background: "white" }}>
              <div className="dash-value-data1" style={{background: handleBackground(list._id), paddingLeft:"2rem", color:"green"}}>{Money(handleQuantityIn(list))}</div>
              <div className="dash-value-data2" style={{background: handleBackground(list._id), paddingLeft:"2rem",color:"red"}}>{Money(handleQuantityOut(list))}</div>
              ...
              <div className="dash-value-data4" style={{background: handleBackground(list._id), paddingLeft:"2rem",color:"green"}}>{Money(handleAmountIn(list))}</div>
              <div className="dash-value-data5" style={{background: handleBackground(list._id), paddingLeft:"2rem",color:"red"}}>{Money(handleAmountOut(list))}</div>
